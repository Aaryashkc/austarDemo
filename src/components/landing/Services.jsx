...
const Services = () => {
    return (
        <section className="py-20 lg:py-32 bg-white relative overflow-hidden">
            ...
            <div className="absolute -bottom-50 -left-50 size-120 bg-brand-red rounded-full pointer-events-none z-0"></div>

            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">

                    {/* Left Column: Content (40%) */}
                    <div className="w-full lg:w-[40%] flex flex-col items-start space-y-8">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold text-text-primary mb-5 leading-[1.1]">
                        ...
                        <Link href="/services" className="px-8 py-3 rounded-lg text-text-primary font-medium hover:bg-brand-red hover:text-white transition-all duration-300  inline-flex items-center gap-2 group">
